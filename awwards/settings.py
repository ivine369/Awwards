...
SECRET_KEY = 'tu%(m_#4fms0t$xa@=da1=jz(wf^lm2a936&kw1xg560r!w1mm'
...
DATABASES = {
    'default': {
           ...
           'USER': "kiiru",
           'PASSWORD': "Access",
           'HOST': "'.localhost','.herokuapp.com','.127.0.0.1'",
           'PORT': '5432',   
    }
}
...
DATABASE_URL='postgres://kiiru:Access@localhost/apportion'
